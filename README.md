...
## How To Install
1. [Download](https://apps.apple.com/gb/app/testing-tools-for-xcode/id6739305231?mt=12) the extension from the App Store.
2. Open the app and follow the setup instructions.

## How To Use

<details>
  <summary>Generate Struct Definition</summary>

  ![Example of creating a struct](assets/CreateStruct.gif)
</details>

<details>
  <summary>Generate Class Definition</summary>

  ![Example of creating a class](assets/CreateClass.gif)
</details>

<details>
  <summary>Handle a To Do List in Xcode</summary>

  ![Example of marking an item in progress and done](assets/InProgressAndDone.gif)
</details>
